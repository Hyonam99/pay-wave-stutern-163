...
describe("test the customer bar component", () => {
    ...
    it("renders the status component for paid invoices", () => {
    ...
    it("renders the status component for pending invoices", () => {
    ...
    it("renders the status component for draft invoices", () => {
